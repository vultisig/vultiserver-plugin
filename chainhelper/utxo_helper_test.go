...
func TestUTXOHelper_BTC_MultipleOutputs(t *testing.T) {
	utxoHelper := NewUTXOChainHelper(core.CoinTypeBitcoin)
	assert.NotNil(t, utxoHelper)
	memo := "voltix"
	payload := &v1.KeysignPayload{
		...
		Outputs: []*v1.Output{
			{
				Address: "bc1qj9q4nsl3q7z6t36un08j6t7knv5v3cwnnstaxu", // Different address first
				Amount:  "9000",
			},
			{
				Address: "bc1q4e4y3g85dtkx0yp3l2flj2nmugf23c9wwtjwu5",
...
func TestUTXOHelper_BCH(t *testing.T) {
	...
	payload := &v1.KeysignPayload{
		...
		Outputs: []*v1.Output{
			{
				Address: "bitcoincash:qqxjcn4u4fgxvclqyaprkem3hptm3nf5yq3ryq70ry",
				Amount:  "1000000",
			},
		},
		BlockchainSpecific: &v1.KeysignPayload_UtxoSpecific{
